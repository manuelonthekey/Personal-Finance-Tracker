...
- Ensure the bug was not already reported by searching [existing issues](https://github.com/manuelonthekey/Personal-Finance-Tracker/issues).
...
- Search [existing issues](https://github.com/manuelonthekey/Personal-Finance-Tracker/issues) for similar feature requests.
...
1. **Clone** the repository:
   ```bash
   git clone https://github.com/manuelonthekey/Personal-Finance-Tracker.git
   ```
